    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-cb-card rounded-xl shadow-xl border border-cb-border p-8">
                <form method="POST" action="<?php echo e(route('admin.judges.store')); ?>" class="space-y-6">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="specialty" required
                                    ...
                                    <option value="Algoritmos" <?php echo e(old('specialty') == 'Algoritmos' ? 'selected' : ''); ?>>Algoritmos</option>
                                    <option value="Estructuras de Datos" <?php echo e(old('specialty') == 'Estructuras de Datos' ? 'selected' : ''); ?>>Estructuras de Datos</option>
                                    <option value="Programación Dinámica" <?php echo e(old('specialty') == 'Programación Dinámica' ? 'selected' : ''); ?>>Programación Dinámica</option>
                                    <option value="Grafos" <?php echo e(old('specialty') == 'Grafos' ? 'selected' : ''); ?>>Grafos</option>
                                    <option value="Matemáticas" <?php echo e(old('specialty') == 'Matemáticas' ? 'selected' : ''); ?>>Matemáticas</option>
                                    <option value="Inteligencia Artificial" <?php echo e(old('specialty') == 'Inteligencia Artificial' ? 'selected' : ''); ?>>Inteligencia Artificial</option>
                                    <option value="Bases de Datos" <?php echo e(old('specialty') == 'Bases de Datos' ? 'selected' : ''); ?>>Bases de Datos</option>
                                    <option value="Desarrollo Web" <?php echo e(old('specialty') == 'Desarrollo Web' ? 'selected' : ''); ?>>Desarrollo Web</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <select name="certification_level" required
                                    class="w-full bg-cb-dark border border-cb-border rounded-lg px-4 py-2 text-white focus:border-cb-green focus:ring focus:ring-cb-green/20 transition">
                                    <option value="">Seleccionar...</option>
                                    <option value="Junior" <?php echo e(old('certification_level') == 'Junior' ? 'selected' : ''); ?>>🎯 Junior</option>
                                    <option value="Senior" <?php echo e(old('certification_level') == 'Senior' ? 'selected' : ''); ?>>⭐ Senior</option>
                                    <option value="Expert" <?php echo e(old('certification_level') == 'Expert' ? 'selected' : ''); ?>>🏆 Expert</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="number" name="experience_years" value="<?php echo e(old('experience_years', 0)); ?>" min="0" required
                                    class="w-full bg-cb-dark border border-cb-border rounded-lg px-4 py-2 text-white focus:border-cb-green focus:ring focus:ring-cb-green/20 transition">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="bio" rows="4"
                            class="w-full bg-cb-dark border border-cb-border rounded-lg px-4 py-2 text-white focus:border-cb-green focus:ring focus:ring-cb-green/20 transition"
                            placeholder="Describe la experiencia y logros del juez..."><?php echo e(old('bio')); ?></textarea>
                        <?php $__errorArgs = ['bio'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php endif; ?><?php /**PATH C:\Users\samue\OneDrive\Escritorio\Programacion web\PROYECTO\resources\views/admin/judges/create.blade.php ENDPATH**/ ?>