        ...
        <div class="w-full max-w-md">
            <div class="bg-cb-card rounded-2xl shadow-2xl border border-cb-border p-8">
                ...
                <div class="flex mb-8 bg-cb-dark rounded-lg p-1">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="flex-1 py-2 px-4 text-gray-400 hover:text-white rounded-lg font-semibold text-center transition-all">
                        Registrarse
                    </a>
                </div>
                ...
                <?php if($errors->any()): ?>
                    <div class="mb-4 p-4 bg-red-500/10 border border-red-500 rounded-lg">
                        <p class="text-red-400 text-sm"><?php echo e($errors->first()); ?></p>
                    </div>
                <?php endif; ?>
                ...
                <?php if(session('status')): ?>
                    <div class="mb-4 p-4 bg-green-500/10 border border-green-500 rounded-lg">
                        <p class="text-green-400 text-sm"><?php echo e(session('status')); ?></p>
                    </div>
                <?php endif; ?>
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <?php if(Route::has('password.request')): ?>
                            <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-cb-green hover:text-green-400 transition-colors">
...
</html><?php /**PATH C:\Users\samue\OneDrive\Escritorio\Programacion web\PROYECTO\resources\views/auth/login.blade.php ENDPATH**/ ?>