        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
                ...
                <div class="bg-cb-card p-6 rounded-xl border border-cb-border">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-white"><?php echo e(count($venues)); ?></p>
                        </div>
                ...
                <div class="bg-cb-card p-6 rounded-xl border border-cb-border">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-white"><?php echo e(array_sum(array_column($venues, 'capacity'))); ?></p>
                        </div>
                ...
                <div class="bg-cb-card p-6 rounded-xl border border-cb-border">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-white"><?php echo e(array_sum(array_column($venues, 'upcoming_events'))); ?></p>
                        </div>
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <?php $__currentLoopData = $venues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $venue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-cb-card rounded-xl shadow-xl border border-cb-border hover:border-cb-green/50 transition duration-300 overflow-hidden group">
                        ...
                        <div class="bg-gradient-to-r from-cb-green/20 to-cb-card p-6 border-b border-cb-border">
                            <div class="flex items-start justify-between">
                                <div class="flex items-center space-x-4">
                                    <div class="text-5xl"><?php echo e($venue['image']); ?></div>
                                    <div>
                                        <h3 class="text-xl font-bold text-white"><?php echo e($venue['name']); ?></h3>
                                        <p class="text-cb-green font-semibold"><?php echo e($venue['acronym']); ?></p>
                                    </div>
                                </div>
                                <span class="px-3 py-1 bg-cb-green/20 text-cb-green border border-cb-green rounded-full text-xs font-bold">
                                    <?php echo e($venue['upcoming_events']); ?> eventos
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    <p class="text-white font-medium"><?php echo e($venue['address']); ?></p>
                                    <p class="text-gray-400 text-sm"><?php echo e($venue['city']); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center justify-between p-3 bg-cb-dark/50 rounded-lg">
                                ...
                                <span class="text-white font-bold"><?php echo e($venue['capacity']); ?> personas</span>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <?php $__currentLoopData = array_slice($venue['features'], 0, 4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex items-center space-x-2 text-sm">
                                            <i class="fas fa-check text-cb-green text-xs"></i>
                                            <span class="text-gray-400"><?php echo e($feature); ?></span>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                                <?php if(count($venue['features']) > 4): ?>
                                    <p class="text-cb-green text-xs mt-2">+<?php echo e(count($venue['features']) - 4); ?> más</p>
                                <?php endif; ?>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="space-y-2">
                                    <?php $__currentLoopData = array_slice($venue['events'], 0, 2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex items-center justify-between p-2 bg-cb-dark/30 rounded">
                                            <div>
                                                <p class="text-white text-sm font-medium"><?php echo e($event['name']); ?></p>
                                                <p class="text-gray-400 text-xs"><?php echo e($event['date']); ?> • <?php echo e($event['participants']); ?> participantes</p>
                                            </div>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            ...
                            <div class="grid grid-cols-2 gap-3 pt-4">
                                <a href="https://www.google.com/maps/search/?api=1&query=<?php echo e($venue['lat']); ?>,<?php echo e($venue['lng']); ?>" 
                                   target="_blank"
                                ...
                                <button onclick="showEvents<?php echo e($venue['id']); ?>.showModal()" 
                    ...
                    <dialog id="showEvents<?php echo e($venue['id']); ?>" class="rounded-xl bg-cb-card border border-cb-border p-0 backdrop:bg-black/70">
                        <div class="w-full max-w-2xl">
                            <div class="bg-gradient-to-r from-cb-green/20 to-cb-card p-6 border-b border-cb-border">
                                <div class="flex items-center justify-between">
                                    <h3 class="text-2xl font-bold text-white">Eventos en <?php echo e($venue['acronym']); ?></h3>
                                    <button onclick="showEvents<?php echo e($venue['id']); ?>.close()" class="text-gray-400 hover:text-white">
                                        <i class="fas fa-times text-xl"></i>
                                    </button>
                                </div>
                            </div>
                            <div class="p-6 space-y-4 max-h-96 overflow-y-auto">
                                <?php $__currentLoopData = $venue['events']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="bg-cb-dark/50 p-4 rounded-lg border border-cb-border hover:border-cb-green/50 transition">
                                        <div class="flex items-start justify-between mb-2">
                                            <h4 class="text-white font-bold"><?php echo e($event['name']); ?></h4>
                                        ...
                                        <div class="flex items-center space-x-4 text-sm text-gray-400">
                                            <div class="flex items-center space-x-2">
                                                ...
                                                <span><?php echo e($event['participants']); ?> participantes</span>
                                            </div>
                                            <div class="flex items-center space-x-2">
                                                <i class="fas fa-map-marker-alt text-cb-green"></i>
                                                <span><?php echo e($venue['acronym']); ?></span>
                                            </div>
                                        </div>
                                        <div class="mt-3">
                                            ...
                                            <?php else: ?>
                                                <a href="<?php echo e(route('login')); ?>" class="block w-full text-center bg-cb-green hover:bg-green-600 text-cb-dark font-bold py-2 px-4 rounded-lg transition">
...
<?php endif; ?><?php /**PATH C:\Users\samue\OneDrive\Escritorio\Programacion web\PROYECTO\resources\views/venues/index.blade.php ENDPATH**/ ?>