                ...
                <form method="POST" action="{{ route('admin.judges.store') }}" class="space-y-6">
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="specialty" required
                                    ...
                                    <option value="Algoritmos" {{ old('specialty') == 'Algoritmos' ? 'selected' : '' }}>Algoritmos</option>
                                    <option value="Estructuras de Datos" {{ old('specialty') == 'Estructuras de Datos' ? 'selected' : '' }}>Estructuras de Datos</option>
                                    <option value="Programación Dinámica" {{ old('specialty') == 'Programación Dinámica' ? 'selected' : '' }}>Programación Dinámica</option>
                                    <option value="Grafos" {{ old('specialty') == 'Grafos' ? 'selected' : '' }}>Grafos</option>
                                    <option value="Matemáticas" {{ old('specialty') == 'Matemáticas' ? 'selected' : '' }}>Matemáticas</option>
                                    <option value="Inteligencia Artificial" {{ old('specialty') == 'Inteligencia Artificial' ? 'selected' : '' }}>Inteligencia Artificial</option>
                                    <option value="Bases de Datos" {{ old('specialty') == 'Bases de Datos' ? 'selected' : '' }}>Bases de Datos</option>
                                    <option value="Desarrollo Web" {{ old('specialty') == 'Desarrollo Web' ? 'selected' : '' }}>Desarrollo Web</option>
                                </select>
                                @error('specialty')
                                    <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <select name="certification_level" required
                                    class="w-full bg-cb-dark border border-cb-border rounded-lg px-4 py-2 text-white focus:border-cb-green focus:ring focus:ring-cb-green/20 transition">
                                    <option value="">Seleccionar...</option>
                                    <option value="Junior" {{ old('certification_level') == 'Junior' ? 'selected' : '' }}>🎯 Junior</option>
                                    <option value="Senior" {{ old('certification_level') == 'Senior' ? 'selected' : '' }}>⭐ Senior</option>
                                    <option value="Expert" {{ old('certification_level') == 'Expert' ? 'selected' : '' }}>🏆 Expert</option>
                                </select>
                    ...
                    <div>
                        ...
                        <textarea name="bio" rows="4"
                            class="w-full bg-cb-dark border border-cb-border rounded-lg px-4 py-2 text-white focus:border-cb-green focus:ring focus:ring-cb-green/20 transition"
                            placeholder="Describe la experiencia y logros del juez...">{{ old('bio') }}</textarea>
                        @error('bio')
                            <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
